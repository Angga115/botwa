...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:ANGGA GANS\n' // GANTI NAMA LU
            + 'ORG:OWNER BOTZ;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6282310972513:+62 823-1097-2513\n' // GANTI NOMOR LU
            + 'END:VCARD'
...
// DOWNLOAD
				...
				if (isLimit(sender)) return reply(nad.limitend(pusname))
					...
					baby.sendMessage(from, oasu, image, {quoted: mek, caption: infomp4})
				...
				if (isLimit(sender)) return reply(nad.limitend(pusname))
					...
					case 'igiphoto':
					     ...
					     baby.sendMessage(from, buffer, image, {quoted: mek, caption: cuyy})
					     await limitAdd(sender)
					break
					case 'igvideo':
					     if (isBanned) return reply(nad.baned())
					     ...
					     baby.sendMessage(from, ige, video, {mimetype: 'video/mp4', quoted: mek})
					     await limitAdd(sender)
					break
// GABUTZ MENU
				case 'tebakin':
...
// MAKER MENU
           ...
           if (isLimit(sender)) return reply(nad.limitend(pusname))
				...
				var nin = gh.split("&")[0];
				var ja = gh.split("&")[1];
				if (args.length < 1) return reply(`Teksnya mana kak?\nContoh : ${prefix}ninjalogo BOTWA & Ramlan ID`)
				reply(nad.wait())
		...
		case 'halloweentext':
           ...
           if (isLimit(sender)) return reply(nad.limitend(pusname))				
		    ...
		    baby.sendMessage(from, bumfer, image, {quoted: mek})
		    await limitAdd(sender)
		    break
		case 'smoketext':
           if (isBanned) return reply(nad.baned())
           if (!isRegistered) return reply(nad.noregis())
           if (isLimit(sender)) return reply(nad.limitend(pusname))
				if (args.length < 1) return reply(`Teksnya mana kak?\nContoh : ${prefix}smoketext Ramlan ID`)
				smoke = body.slice(11)
		    ...
		    baby.sendMessage(from, bunfer, image, {quoted: mek})
		    await limitAdd(sender)
		    break
           case 'neontext':
           if (isBanned) return reply(nad.baned())
           ...
           baby.sendMessage(from, busfer, image, {quoted: mek})
		    await limitAdd(sender)
           break
           case 'tahta':
           if (isBanned) return reply(nad.baned())
           ...
           baby.sendMessage(from, butfer, image, {quoted: mek})
		    await limitAdd(sender)
           break
				case 'pornhub':
           if (isBanned) return reply(nad.baned())
           ...
           if (isLimit(sender)) return reply(nad.limitend(pusname))
				...
				baby.sendMessage(from, bukfer, image, {quoted: mek})
				await limitAdd(sender)
				break
           case 'blackpink':
           if (isBanned) return reply(nad.baned())
           ...
           baby.sendMessage(from, bupper, image, {quoted: mek})
		    await limitAdd(sender)
           break
				case 'glitchtext':
           if (isBanned) return reply(nad.baned())
           ...
           baby.sendMessage(from, busser, image, {quoted: mek})
		    await limitAdd(sender)
           break
// OWNER
                case 'addprem':
...
// RANDOM MENU
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, ahe, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'erohentong':
				if (isBanned) return reply(nad.baned())
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, ahu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'cuckold':
				if (isBanned) return reply(nad.baned())
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, avu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'jahyhentong':
				if (isBanned) return reply(nad.baned())
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, aku, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'randommanga':
				if (isBanned) return reply(nad.baned())
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, alu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'orgyhentong':
				if (isBanned) return reply(nad.baned())
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, azu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'panties':
				if (isBanned) return reply(nad.baned())
				...
				reply(nad.wait())
					baby.sendMessage(from, acu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'nsfwneko':
				if (isBanned) return reply(nad.baned())
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, abu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'wpsfw':
				if (isBanned) return reply(nad.baned())
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, anu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'sfwneko':
				if (isBanned) return reply(nad.baned())
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, amu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					await limitAdd(sender)
					break
					case 'bdsmhentong':
				if (isBanned) return reply(nad.baned())
				...
				reply('Tobat bro tobat :v')
					baby.sendMessage(from, aqu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					break
					case 'sangewibu':
				if (isBanned) return reply(nad.baned())
                if (!isRegistered) return reply(nad.noregis())
				...
				reply(nad.wait())
					baby.sendMessage(from, afu, image, {quoted: mek, caption: 'Jangan Comly >_<'})
					break
// OTHER
                case 'moddroid':
                  if (isBanned) return reply(nad.baned())
